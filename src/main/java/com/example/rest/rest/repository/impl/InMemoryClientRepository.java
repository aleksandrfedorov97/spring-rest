...
public class InMemoryClientRepository implements ClientRepository {
    ...
    public Client update(Client client) {
        ...
        if (currentClient == null) {
            throw new EntityNotFoundException(MessageFormat.format("Клиетн по ID {} не найден!", clientId));
        }
    ...
    public void deleteById(Long id) {
        ...
        if (client == null) {
            throw new EntityNotFoundException(MessageFormat.format("Клиетн по ID {} не найден!", id));
        }
